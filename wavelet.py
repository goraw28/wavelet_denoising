...
for i in glob.glob('C:\\Users\\GauravUgale\\Desktop\\ML_projects\\All_files_check\\gdfdh\\*.csv'):
    ...
    zz =np.std(z)
    # zzz =pd.DataFrame(zz).to_csv(f'C:\Users\GauravUgale\Desktop\test_to\{}')
    print(zz)
...
rtr.to_csv('C:\\Users\\GauravUgale\\Desktop\\test_to\\check.csv',index=False)